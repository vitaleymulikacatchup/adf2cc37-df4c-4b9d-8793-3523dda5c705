...
export const metadata: Metadata = {
  title: "Happy-Coder | Learn Programming & Start Your Tech Career",
  description: "Master web development, Python, mobile apps & UI/UX design. Join Happy-Coder IT school and launch your tech career with expert instructors.",
  keywords: "coding courses, programming school, web development, Python, mobile app development, IT education",
  metadataBase: new URL("https://happy-coder.com"),
  alternates: {
    canonical: "https://happy-coder.com"
  },
  openGraph: {
    title: "Happy-Coder | Learn to Code. Build Your Future.",
    description: "Master programming through hands-on learning with industry experts",
    siteName: "Happy-Coder",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764934345464-40htgmrz.jpg",
        alt: "Happy-Coder IT School"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Happy-Coder | Learn to Code",
    description: "Start your tech career with our comprehensive coding courses",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1764934345464-40htgmrz.jpg"]
  },
  robots: {
    index: true,
    follow: true
